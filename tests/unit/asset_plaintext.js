describe('asset plain text', function() {
    ...
    beforeEach(function () {
        descritor = new WOZLLA.asset.PlainTextDescriptor(testTool.RES_BASE + "tests/res/plaintext.txt");
    ...
    it('load without AssetManager', function (done) {
        var loader = new WOZLLA.asset.PlainTextLoader();
        loader.loadAsync(descritor, function(err, asset) {
            expect(!!err).toBeFalsy();
            expect(asset instanceof WOZLLA.asset.PlainTextAsset).toBeTruthy();
    ...
    it('load group without AssetManager', function(done) {
        ...
        var loader3 = new WOZLLA.asset.PlainTextLoader();
