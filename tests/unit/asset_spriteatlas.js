describe('asset sprite atlas', function() {
    ...
    beforeEach(function () {
        descritor = new WOZLLA.asset.SpriteAtlasDescriptor(testTool.RES_BASE + "tests/res/common.tt.json");
    ...
    it('load without AssetManager', function (done) {
        var loader = new WOZLLA.asset.SpriteAtlasLoader();
        loader.loadAsync(descritor, function(err, asset) {
            expect(!!err).toBeFalsy();
            expect(asset instanceof WOZLLA.asset.SpriteAtlas).toBeTruthy();
            expect(asset.getSprite('Lv.png')).toBeInstanceOf(WOZLLA.asset.Sprite);
            done();
        });
    });
    ...
    it('load group without AssetManager', function(done) {
        ...
        var loader3 = new WOZLLA.asset.SpriteAtlasLoader();
